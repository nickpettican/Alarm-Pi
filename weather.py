...
class Weather:
    ...
    def weather_talk(self):
        ...
        high_low = 'The temperature will reach a high of %s, and a low of %s.' %(self.today_info['current_high'],self.today_info['current_low'])
        ...
        sun_rise_set = 'The sun today rises at %s, and sets at %s.' %(self.today_info['sunrise'], self.today_info['sunset'])
